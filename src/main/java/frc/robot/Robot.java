...
//   private LiftSubsystem liftsystem = new LiftSubsystem(true);
...
//     // drive.arcadeDrive(controller.getLeftY() /2.0, controller.getRightX()/2.0);
...
//     SmartDashboard.putString("startrunning", "running");
//     Commands.runOnce(() -> liftsystem.runWithSetPoint(2.0), liftsystem);
//     SmartDashboard.putString("runwithsetpoint", "moving");
//   }
...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    // drive.tankDrive(controller.getLeftY() / 1.5, controller.getRightY() / 1.5);
    // drive.curvatureDrive(controller.getRightY(), controller.getRightX(), true);
    left_motor.set(controller.getLeftY());
    SmartDashboard.putNumber("encoder position", encoder.getPosition());
    SmartDashboard.putNumber("encoder velocity", encoder.getVelocity());
    SmartDashboard.putNumber("controller value", controller.getLeftY());
  }
